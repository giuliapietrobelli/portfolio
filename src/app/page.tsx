  ...
  return (
    <main className="flex flex-col items-center justify-between px-1">
      ...
      <div id="hero" className="flex flex-col flex-wrap min-h-52 slide">
        <h1 id="intro" className="w-9/12 sm:w-8/12 md:w-8/12 xl:w-8/12 m-auto text-center sm:py-20 lg:py-24 px-8 text-2xl sm:text-3xl lg:text-5xl font-normal text-zinc-900">
          Ciao! I&apos;m Giulia, a <b>digital designer</b> based in Italy.
        </h1>
      </div> 

      <div id="home-gallery" className="grid gap-10 md:grid-cols-2 md:py-10 px-6 md:px-8">
