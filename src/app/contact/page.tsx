...
export default function Contact() {
  ...
  return (
    <div className="container flex flex-col items-center gap-6 md:gap-10 py-60">
      ...
      <form onSubmit={handleSubmit} className="mt-4 space-y-4 text-center max-w-lg">
        <div>
        ...
        <div className="text-center">
          <button
            // disabled={true}
            type="submit"
            className="py-5 px-8 text-sm bg-zinc-700 hover:bg-zinc-600 transition-all border-0 text-white m-16"
          >
            submit your message
          </button>
        </div>
