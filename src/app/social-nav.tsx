  ...
  return (
    ...
    className={props.isMenuOpen
     ...
     : closeClasses
      ...
      <li>
        <Link href="https://www.linkedin.com/in/giuliapietrobelli/" target='blank'>
        <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet" fill="#18181B" width="32" height="32">
          <path
      ...
      <li>
        <Link href="https://dribbble.com/giuliapietrobelli" target='blank'>
        <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet" fill="#18181B" width="32" height="32">
          <path
      ...
      <li>
        <Link href="https://www.behance.net/giuliapietrobelli7be" target='blank'>
        <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet" fill="#18181B" width="32" height="32">
          <path
